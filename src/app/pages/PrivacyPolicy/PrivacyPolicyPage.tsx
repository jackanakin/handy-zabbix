...
function PrivacyPolicyPage() {
    return (
        <>
            ...
            <Content>
                <Text>This privacy policy is applied to the "Application" Handy Zabbix, which is only available at <a href='https://play.google.com/store/apps/details?id=br.dev.kuhn.handyzabbix'>Google Play</a> for download</Text>
                <Text>The Application purpose is to provide an useful integration for Android phones with <a href='https://www.zabbix.com/' >Zabbix</a> monitoring system</Text>
                ...
                <Text>No personal/private data or any described in <a href='https://support.google.com/googleplay/android-developer/answer/10787469?hl=en#types&zippy=%2Cdata-types'>Play Console Help</a> "Data types" are collected, stored or shared</Text>
                ...
                <Text>Also, note that the Application make use of some/all data provided by API's in the <a href='https://www.zabbix.com/documentation/current/en/manual/api/reference'>Zabbix API Method reference</a>, part of this data may be stored in your phone local storage for the Application to work correctly. These data are only used/processed/stored by the Application itself, nothing is shared or collected by third parties</Text>
                ...
                <Text>Note that the Application support both HTTP(insecure) and HTTPS(secure) protocols, it's your responsibility and risk to choose between them</Text>
                <Text>Sites credentials/tokens as well their permissions are defined in your Zabbix site instance as described <a href='https://www.zabbix.com/documentation/current/en/manual/config/users_and_usergroups'>here</a>, therefore I share no responsibility securing these credentials/tokens and their respective permissions</Text>
